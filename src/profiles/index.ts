...
import { loadEquipmentProfile, loadNetworkProfile, loadRegionProfile, loadVendorProfile } from './loader';
 ...
 * YAML files (e.g. to point at a different vendor, equipment catalog, or region)
 * through the same loadXProfile functions with zero code changes elsewhere.
 */
